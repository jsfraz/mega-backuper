...
type Backup struct {
	...
	MysqlHost     string `json:"mysqlHost" validate:"required_if=Type mysql,omitempty,required"`
	MysqlPort     int    `json:"mysqlPort" validate:"required_if=Type mysql,omitempty,required"`
}
